...
class Router:
    ...
    def run(self, start : Tile , ends: list[Tile]):
    ...
    def reconstruct_path(self, came_from, current) -> list[Tile]:
...
class AStarRouter(Router):
    ...
    def route(self, start : Tile , end : Tile ,):
        count = 0
        ...
        while not open_set.empty():
            ...
            for n in current.neighbors:
                ...
                if n.layer.index != current.layer.index: 
                    cost = 10 
                else : 
                    cost = 1


                current_g_score = g_score[current] + cost
